	...
	SubShader
	{
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				float2 texCoord34 = input.ase_texcoord9.zw * float2( 1,1 ) + float2( 0,0 );
				float temp_output_22_0 = ( input.ase_color.a / _Threshold );
				float4 lerpResult16 = lerp( ( tex2DNode1 * _Color0 ) , ( tex2D( _Albedo, texCoord34 ) * _Color ) , temp_output_22_0);
				
				float2 texCoord41 = input.ase_texcoord9.xy * float2( 1,1 ) + float2( 0,0 );
				float2 texCoord35 = input.ase_texcoord9.zw * float2( 1,1 ) + float2( 0,0 );
				...
				float2 texCoord36 = input.ase_texcoord9.zw * float2( 1,1 ) + float2( 0,0 );
		...
		Pass
		{
			...
			half4 frag(PackedVaryings input  ) : SV_Target
			{
				...
				float4 tex2DNode1 = tex2D( _MainTex, uv_MainTex );
				float2 texCoord34 = input.ase_texcoord4.zw * float2( 1,1 ) + float2( 0,0 );
				float temp_output_22_0 = ( input.ase_color.a / _Threshold );
				float4 lerpResult16 = lerp( ( tex2DNode1 * _Color0 ) , ( tex2D( _Albedo, texCoord34 ) * _Color ) , temp_output_22_0);
		...
		Pass
		{
			...
			half4 frag(PackedVaryings input  ) : SV_Target
			{
				...
				float4 tex2DNode1 = tex2D( _MainTex, uv_MainTex );
				float2 texCoord34 = input.ase_texcoord2.zw * float2( 1,1 ) + float2( 0,0 );
				float temp_output_22_0 = ( input.ase_color.a / _Threshold );
				float4 lerpResult16 = lerp( ( tex2DNode1 * _Color0 ) , ( tex2D( _Albedo, texCoord34 ) * _Color ) , temp_output_22_0);
		...
		Pass
		{
						 ...
						 )
			{
				...
				float2 texCoord35 = input.ase_texcoord5.zw * float2( 1,1 ) + float2( 0,0 );
				float temp_output_22_0 = ( input.ase_color.a / _Threshold );
				float4 lerpResult24 = lerp( tex2D( _BumpMap, texCoord41 ) , tex2D( _BumpMap2, texCoord35 ) , temp_output_22_0);
