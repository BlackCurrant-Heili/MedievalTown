	...
	SubShader
	{
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				float2 texCoord22 = input.ase_texcoord9.zw * float2( 1,1 ) + float2( 0,0 );
				
				float2 texCoord26 = input.ase_texcoord9.xy * float2( 1,1 ) + float2( 0,0 );
				float3 unpack5 = UnpackNormalScale( tex2D( _BumpMap, texCoord26 ), _BumpScale );
				unpack5.z = lerp( 1, unpack5.z, saturate(_BumpScale) );
				float2 texCoord37 = input.ase_texcoord9.zw * float2( 1,1 ) + float2( 0,0 );
				...
				float2 uv_Metallic = input.ase_texcoord9.xy * _Metallic_ST.xy + _Metallic_ST.zw;
		...
		Pass
		{
			...
			half4 frag(PackedVaryings input  ) : SV_Target
			{
				...
				float4 tex2DNode1 = tex2D( _MainTex, uv_MainTex );
				float2 texCoord22 = input.ase_texcoord4.zw * float2( 1,1 ) + float2( 0,0 );
		...
		Pass
		{
			...
			half4 frag(PackedVaryings input  ) : SV_Target
			{
				...
				float4 tex2DNode1 = tex2D( _MainTex, uv_MainTex );
				float2 texCoord22 = input.ase_texcoord2.zw * float2( 1,1 ) + float2( 0,0 );
		...
		Pass
		{
						 ...
						 )
			{
				...
				float2 texCoord26 = input.ase_texcoord5.xy * float2( 1,1 ) + float2( 0,0 );
				float3 unpack5 = UnpackNormalScale( tex2D( _BumpMap, texCoord26 ), _BumpScale );
				unpack5.z = lerp( 1, unpack5.z, saturate(_BumpScale) );
				float2 texCoord37 = input.ase_texcoord5.zw * float2( 1,1 ) + float2( 0,0 );
				float3 unpack36 = UnpackNormalScale( tex2D( _DetailNormalMap, texCoord37 ), _DetailNormalMapScale );
				unpack36.z = lerp( 1, unpack36.z, saturate(_DetailNormalMapScale) );
